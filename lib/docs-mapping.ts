...
export const docsMapping: DocMapping[] = [
  ...
  },
  {
    ...
    app: 'video-upsells',
    title: 'Getting Started - Product Page Video Upsells',
    order: 2,
  },
  {
    wpSlug: 'post-purchase-video-upsells',
    nextSlug: 'post-purchase',
    app: 'video-upsells',
    title: 'Post Purchase Video Upsells',
    order: 3,
  },
  {
    wpSlug: 'thank-you-page-video-upsells',
    nextSlug: 'thank-you-page',
    app: 'video-upsells',
    title: 'Thank You Page Video Upsells',
    order: 4,
  },
  {
